  ...
  <ZoomTransition :duration="250">
    ...
    >
      <div class="relative select-none">
        <div
          class="grid grid-cols-2 grid-rows-2 w-52 h-52 bg-gray-900 border-2 border-blue-300 rounded-full transform rotate-45 shadow-xl shadow-gray-900 divide-x divide-y divide-gray-700 overflow-hidden"
        >
        ...
        <div
          class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center w-20 h-20 bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 p-1.5 shadow-md rounded-full"
          @click="wheelItemHandler(BoardItem.EMPTY)"
        >
          <div
            class="flex justify-center items-center w-full h-full bg-gray-800 rounded-full text-2xl cursor-pointer hover:bg-gray-700"
          >
