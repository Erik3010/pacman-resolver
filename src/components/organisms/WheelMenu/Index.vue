  ...
  <ZoomTransition :duration="250">
    ...
    >
      <div class="relative select-none">
        <div
          class="grid grid-cols-2 grid-rows-2 bg-gray-900 border-2 border-blue-300 rounded-full w-52 h-52 transform rotate-45 overflow-hidden shadow-xl shadow-gray-900 divide-gray-700 divide-x divide-y"
        >
